                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'html_content' => '<div class="form-group">' .
                            ...
                            '<strong>' . Tools::getHttpHost(true) . __PS_BASE_URI__ . 'index.php?fc=module&module=' . $this->name . '&controller=cron&token=' . Configuration::get('VERIFACTU_CRON_TOKEN') . '</strong>' .
                            '</div>' .
                            '<p><strong>' . $this->l('Ejemplo de comando de Cron (cada 5 minutos):') . '</strong><br><code>*/5 * * * * curl -s -O /dev/null "' . Tools::getHttpHost(true) . __PS_BASE_URI__ . 'index.php?fc=module&module=' . $this->name . '&controller=cron&token=' . Configuration::get('VERIFACTU_CRON_TOKEN') . '"</code></p>' .
