<?php
/**
 * VeriFactu Cronjob Script via FrontController
 * Permite ejecutar las tareas de sincronización de manera automática y desatendida.
 */

class VerifactuCronModuleFrontController extends ModuleFrontController
{
    public $auth = false;
    public $ajax = true; // Previene cargar el header y footer de PrestaShop
    ...
    public function postProcess()
    {
        ...
        // Cargamos la clase de la API si no estuviese cargada.
        require_once(_PS_MODULE_DIR_ . $this->module->name . '/classes/ApiVerifactu.php');
